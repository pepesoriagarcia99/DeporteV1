package com.pepe.deporte.retrofit.generator;
...
public class ServiceGenerator {
    private static final String BASE_URL = "https://app-deporte.herokuapp.com/";
    public static String MASTER_KEY = "24dAPwweAPUpyOZG9UOOenW3LgVGEU8d";
